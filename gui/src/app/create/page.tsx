...
const templates: Record<ProfileType, object> = {
  filament: {
    ...
    diameter: 1.75,
    density: 0,
    nozzle: { min: 0, max: 0, recommended: 0 },
    bed: { min: 0, max: 0, recommended: 0 },
    fan: { min: 0, max: 100, recommended: 100 },
    drying: { temperature: 0, duration_hours: 0 },
  ...
  printer: {
    ...
    model: "",
    variant: "Stock",
    build_volume: { x: 0, y: 0, z: 0, shape: "rectangular", origin: "front_left" },
    kinematics: "cartesian",
    axes: { x: { max_speed: 0, max_accel: 0 }, y: { max_speed: 0, max_accel: 0 }, z: { max_speed: 0, max_accel: 0 } },
    extruders: [{ id: "tool0", nozzle_diameter: 0.4, nozzle_material: "brass", max_temp: 0, min_temp: 0 }],
    bed: { heated: true, max_temp: 0, surface_type: "" },
  ...
  process: {
    ...
    name: "",
    intent: "standard",
    layer_height: { min: 0, max: 0, default: 0 },
    wall_settings: { wall_count: 3, top_layers: 4, bottom_layers: 4 },
    infill: { density_default: 20, recommended_patterns: [] },
    speed: { outer_wall: 0, inner_wall: 0, infill: 0, travel: 0 },
    retraction: { distance: 0, speed: 0 },
    tags: [],
    notes: "",
  },
};
